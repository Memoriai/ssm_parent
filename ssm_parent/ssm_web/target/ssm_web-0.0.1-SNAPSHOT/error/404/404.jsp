...
<head>
	<title>404</title>
	<link href="${pageContext.request.contextPath}/error/404/css/style.css" rel='stylesheet' type='text/css'/>
...
<body>
	<div class="top-bar-agile">
		<div class="logo-agileits">
			<a href="${pageContext.request.contextPath}/WEB-INF/pages/user/home.jsp"><img src="${pageContext.request.contextPath}/error/404/images/logo.png" alt=" " /></a>
		</div>
